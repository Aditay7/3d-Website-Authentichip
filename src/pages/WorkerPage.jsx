...
const WorkerPage = () => {
	...
	const avgConfidence = (
		recentScans.reduce((acc, curr) => acc + curr.confidence, 0) /
		recentScans.length
	).toFixed(1);
				...
				<div className="max-w-7xl mx-auto space-y-6">
					...
					<div className="mb-8">
						...
						<p className="text-gray-400 text-lg">
							Real-time scan analytics and performance metrics
						</p>
					</div>
					...
					<Card
						title={
							<span className="text-white text-xl font-bold">Recent Scans</span>
						}
						className="!bg-white/5 !border-white/10 backdrop-blur-md"
						headStyle={{
						...
						<List
							...
							renderItem={(item) => (
								<List.Item
									...
									style={{
										background:
											"linear-gradient(90deg, rgba(34, 211, 238, 0.02) 0%, transparent 100%)",
										padding: "20px 32px",
										margin: "0 12px",
										borderRadius: "8px",
									}}
						...
						{selectedScan && (
							<div className="space-y-4 text-gray-300">
								...
								<div className="flex justify-between">
									<span>Status:</span>
									<Tag
										color={selectedScan.status === "PASS" ? "success" : "error"}
									>
										{selectedScan.status}
									</Tag>
								</div>
