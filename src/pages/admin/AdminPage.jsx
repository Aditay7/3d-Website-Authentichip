...
const AdminPage = () => {
	...
	const avgConfidence = (
		scanResults.reduce((acc, curr) => acc + curr.confidence, 0) / totalScans
	).toFixed(1);
	...
	const batchColumns = [
		...
		{
			title: "Part",
			dataIndex: "expectedPartNumber",
			key: "expectedPartNumber",
		},
		...
		<div className="min-h-screen bg-black relative overflow-hidden font-sans">
			...
			<div className="fixed inset-0 pointer-events-none z-0">
				...
				<div
					...
					style={{
						background:
							"linear-gradient(to bottom, rgba(22, 78, 99, 0.3) 0%, rgba(21, 94, 117, 0.35) 50%, rgba(22, 78, 99, 0.25) 100%)",
					}}
				></div>
				<div
					className="absolute inset-0"
					style={{
						background:
							"linear-gradient(to right, rgba(22, 78, 99, 0.2) 0%, transparent 50%, rgba(22, 78, 99, 0.2) 100%)",
					}}
				></div>
					...
					<div className="mb-8">
						<h1
							...
							style={{
								...
								backgroundClip: "text",
								textShadow:
									"0 4px 8px rgba(34, 211, 238, 0.3), 0 0 20px rgba(34, 211, 238, 0.2)",
						...
						<p className="text-gray-400 text-lg">
							Comprehensive system overview and performance insights
						</p>
					</div>
					...
					<Row gutter={[16, 16]}>
						...
						<Col xs={24} sm={12} lg={6}>
							...
							>
								<Statistic
									title={
										<span className="text-gray-400">Avg OCR Confidence</span>
									}
									value={avgConfidence}
									suffix="%"
									valueStyle={{
					...
					<Row gutter={[16, 16]}>
						<Col xs={24} lg={8}>
							<Card
								...
								style={{
									boxShadow:
										"0 8px 32px rgba(34, 211, 238, 0.2), inset 0 1px 0 rgba(255, 255, 255, 0.1)",
								}}
							>
								<div className="h-64">
					...
					<Row gutter={[16, 16]}>
						<Col xs={24} lg={14}>
							<Card
								title={
									<span className="text-white text-lg font-semibold">
										Production Line Batch Analytics
									</span>
								}
							...
							>
								<Table
									...
									pagination={false}
									rowKey="batchId"
									className="admin-batch-table ant-table-dark"
									...
									<ResponsiveContainer width="100%" height="100%">
										<BarChart data={workerStats} layout="vertical">
											...
											<Bar
												...
												style={{
													filter:
														"drop-shadow(0 4px 12px rgba(34, 211, 238, 0.4))",
												}}
											/>
										</BarChart>
									</ResponsiveContainer>
