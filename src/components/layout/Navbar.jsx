...
export default function Navbar() {
	...
	if (typeof window !== "undefined") {
		console.debug("Navbar - userRole:", userRole, "isLoggedIn:", isLoggedIn);
	}
			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				<div className="flex items-center justify-between h-16">
					...
					>
						...
						{userRole && (
							<span className="ml-3 inline-block px-2 py-1 text-xs font-semibold rounded-md bg-cyan-700 text-cyan-100">
